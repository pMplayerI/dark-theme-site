...
$(document).ready(function () {
	...
	$(".social-button").mouseover(function () {
		$(this).css({ "color": "#e0a80d", "background": "#2d2e2e", "border": "2px solid #3f4040" });
	});
	$(".social-button").mouseleave(function () {
		$(this).css({ "color": "#717273", "background": "#3f4040", "border": "none" });
	});

	// Tạo hiệu ứng cho link ở phần Intro
	$(".link-white").mouseover(function () {
		$(this).css({ "text-decoration": "none", "color": "#fefaee" });
	});
	...
	$(".profiles-link").mouseover(function () {
		$(this).css("text-decoration", "none");
		$(".profiles-link-heading", this).css("color", "#fefaee");
